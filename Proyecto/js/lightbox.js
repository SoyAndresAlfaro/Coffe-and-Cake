(function(){
  ...
  //Objeto con las Propiedades del objeto Lightbox
var propLightbox = {
...
//Objeto con los Métodos del objeto Lightbox
var metLightbox = {
  ...
  lightbox: function(imagen){
    ...
    propLightbox.cerrarModal.addEventListener('click', metLightbox.cerrarModal, alert('El click funciona'))
